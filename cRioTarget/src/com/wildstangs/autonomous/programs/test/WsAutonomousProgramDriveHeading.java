...
public class WsAutonomousProgramDriveHeading extends WsAutonomousProgram {
    ...
    public void defineSteps() {
        addStep(new WsAutonomousStepSetDriveHeadingPidRelativeSetpoint(angle.getValue()));
        addStep(new WsAutonomousStepEnableDriveHeadingPid());
        addStep(new WsAutonomousStepWaitForDriveHeadingPid());
    }
