...
/* the project.                                                               */
/*----------------------------------------------------------------------------*/
package com.wildstangs.inputmanager.inputs.camera;
 ...
 * @author dtjones
 */
public class WsCamera implements ISensor {

    private static WsCamera m_instance = null;
    ...
    public static class ExposureT {
        ...
        static final WsCamera.ExposureT[] allValues = new WsCamera.ExposureT[4];
        /**
         * The Axis camera automatically determines what exposure level to use.
         */
        public static final WsCamera.ExposureT automatic = new WsCamera.ExposureT(0);
        /**
         * Hold the current exposure level.
         */
        public static final WsCamera.ExposureT hold = new WsCamera.ExposureT(1);
        /**
         * Set exposure for flicker free 50 hz.
         */
        public static final WsCamera.ExposureT flickerfree50 = new WsCamera.ExposureT(2);
        /**
         * Set exposure for flicker free 60 hz.
         */
        public static final WsCamera.ExposureT flickerfree60 = new WsCamera.ExposureT(3);
        ...
        private static WsCamera.ExposureT get(int val) {
    ...
    public static class WhiteBalanceT {
         ...
         */
        public final int value;
        static final WsCamera.WhiteBalanceT[] allValues = new WsCamera.WhiteBalanceT[7];
        /**
         * The axis camera automatically adjusts the whit balance.
         */
        public static final WsCamera.WhiteBalanceT automatic = new WsCamera.WhiteBalanceT(0);
        /**
         * Hold the current white balance.
         */
        public static final WsCamera.WhiteBalanceT hold = new WsCamera.WhiteBalanceT(1);
        /**
         * White balance for outdoors.
         */
        public static final WsCamera.WhiteBalanceT fixedOutdoor1 = new WsCamera.WhiteBalanceT(2);
        /**
         * White balance for outdoors.
         */
        public static final WsCamera.WhiteBalanceT fixedOutdoor2 = new WsCamera.WhiteBalanceT(3);
        /**
         * White balance for indoors.
         */
        public static final WsCamera.WhiteBalanceT fixedIndoor = new WsCamera.WhiteBalanceT(4);
        /**
         * White balance for fourescent lighting.
         */
        public static final WsCamera.WhiteBalanceT fixedFlour1 = new WsCamera.WhiteBalanceT(5);
        /**
         * White balance for fourescent lighting.
         */
        public static final WsCamera.WhiteBalanceT fixedFlour2 = new WsCamera.WhiteBalanceT(6);
        ...
        private static WsCamera.WhiteBalanceT get(int value) {
    ...
    public static class ResolutionT {
        ...
        static final WsCamera.ResolutionT[] allValues = new WsCamera.ResolutionT[4];
        /**
         * Image is 640 pixels wide by 480 tall
         */
        public static final WsCamera.ResolutionT k640x480 = new WsCamera.ResolutionT(0, 640, 480);
        /**
         * Image is 640 pixels wide by 360 tall
         */
        public static final WsCamera.ResolutionT k640x360 = new WsCamera.ResolutionT(1, 640, 360);
        /**
         * Image is 320 pixels wide by 240 tall
         */
        public static final WsCamera.ResolutionT k320x240 = new WsCamera.ResolutionT(2, 320, 240);
        /**
         * Image is 160 pixels wide by 120 tall
         */
        public static final WsCamera.ResolutionT k160x120 = new WsCamera.ResolutionT(3, 160, 120);
        ...
        private static WsCamera.ResolutionT get(int value) {
            return allValues[value];
        }
    }
    ...
    public static class RotationT {
         ...
         */
        public final int value;
        static final WsCamera.RotationT[] allValues = new WsCamera.RotationT[2];
        /**
         * Picture is right side up.
         */
        public static final WsCamera.RotationT k0 = new WsCamera.RotationT(0);
        /**
         * Picture is rotated 180 degrees.
         */
        public static final WsCamera.RotationT k180 = new WsCamera.RotationT(1);
        ...
        private static WsCamera.RotationT get(int value) {
            return allValues[value];
        }
    }
    ...
    public static class ExposurePriorityT {
         ...
         */
        public final int value;
        static final WsCamera.ExposurePriorityT[] allValues = new WsCamera.ExposurePriorityT[3];
        /**
         * Prioritize image quality.
         */
        public static final WsCamera.ExposurePriorityT imageQuality = new WsCamera.ExposurePriorityT(0);
        /**
         * No prioritization.
         */
        public static final WsCamera.ExposurePriorityT none = new WsCamera.ExposurePriorityT(50);
        /**
         * Prioritize frame rate.
         */
        public static final WsCamera.ExposurePriorityT frameRate = new WsCamera.ExposurePriorityT(100);
        ...
        private static WsCamera.ExposurePriorityT get(int value) {
            return allValues[value / 50];
        }
    }

    /**
     * Get a reference to the WsCamera, or initialize the WsCamera if it
     ...
     * @return A reference to the WsCamera.
     */
    public static synchronized WsCamera getInstance(String address) {
        if (m_instance == null) {
            m_instance = new WsCamera(address);
     ...
     * @return A reference to the WsCamera.
     */
    public static synchronized WsCamera getInstance() {
        if (m_instance == null) {
    ...
    public class WsCameraException extends Exception {
        public WsCameraException(String msg) {
            super(msg);
        }
    }
    ...
    /**
     * Get the current brightness of the WsCamera
     ...
     */
    public void writeWhiteBalance(WsCamera.WhiteBalanceT whiteBalance) {
     ...
     */
    public WsCamera.WhiteBalanceT getWhiteBalance() {
        return WsCamera.WhiteBalanceT.get(getWhiteBalanceFn.call0());
    }
     ...
     */
    public void writeExposureControl(WsCamera.ExposureT value) {
     ...
     */
    public WsCamera.ExposureT getExposureControl() {
        return WsCamera.ExposureT.get(getExposureControlFn.call0());
    }
     ...
     */
    public void writeExposurePriority(WsCamera.ExposurePriorityT value) {
     ...
     */
    public WsCamera.ExposurePriorityT getExposurePriority() {
        return WsCamera.ExposurePriorityT.get(getExposurePriorityFn.call0());
    }
     ...
     */
    public void writeResolution(WsCamera.ResolutionT value) {
     ...
     */
    public WsCamera.ResolutionT getResolution() {
        return WsCamera.ResolutionT.get(getResolutionFn.call0());
    }
     ...
     */
    public void writeRotation(WsCamera.RotationT value) {
     ...
     */
    public WsCamera.RotationT getRotation() {
        return WsCamera.RotationT.get(getRotationFn.call0());
    }
