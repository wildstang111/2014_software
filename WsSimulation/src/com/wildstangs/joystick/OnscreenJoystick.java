 ...
 */
public class OnscreenJoystick implements KeyListener, IJoystick {
    ...
    private static final int JSHEIGHT = 500;//joy stick area height
    private static final int JSWIDTH = 500;//joy stick area width
